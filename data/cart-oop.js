//Object Oriented Programming - Group all data and functions into an object

//The idea of OOP is to represent the real world where a cart is a physical object but in OOP it's a digital object (javascript object). A physical cart can product inside so our javascript cart can have object inside. We can also modify the cart like addTocart/removeFromCart.

//Using function to create multiple object helps keep your code clean and more readable
...
//   loadFromStorage() {//: function() {shorthand Method Syntax
//     this.cartItems = JSON.parse(localStorage.getItem('businessCart-oop'));//takes one string (name of what we saved earlier). Convert to regular string
//         //if there no item in localstorage it will result to null so there need to be a default value attached as shown below.
...
//   //Using localStorage to save the cart from reseting when refreshing the webpage
//   saveToStorage() {
//     localStorage.setItem('businessCart-oop', JSON.stringify(cart));//takes two item. the name of the variable we want to save and the string(convert using JSON.stringify(variablename)).
//   },
...
//   }
// };
const cart = Cart('cart-oop'); //accessing the function and giving it a special key for their localStorage
